...
namespace network
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            int i = 0;
            //ALL CITIES IN 1 ARRAY FOR CHECKING

            //IMPORTANT: I AM USING 0 1 2 CONTROL, WHAT DOES IT MEAN?
            //IT MEANS CITY IS MINE THEN I WILL SET THAT CITY'S INDEX 0
        ...
        void ReceiveData(IAsyncResult iar)
        {
            ...
            //NULL PROTECTION AND SERVER CAN ONLY SEND ME 1 OR 2 DIGIT
            if (receivedData.Length <= 2)
            {
                //CONVERT INDEX INTO INTEGER
                Console.WriteLine(receivedData);
                index = Int32.Parse(receivedData);
